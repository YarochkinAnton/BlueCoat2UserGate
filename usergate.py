...
position_layer	String	readonly rule position, possible values are: pre, post, local
	...
	# +user_agents -> default = []
	# +referers -> default = []
	def __init__(self, _action, _name, _description, _users, _dst_ip_list_name, _src_ip_list_name, _url_list_name):
		self.action = _action
		self.name = _name
		self.description = _description
		self.users = _users
		self.dst_ip_list_id_list = _dst_ip_list_name
		self.src_ip_list_id_list = _src_ip_list_name
		self.url_list_name = _url_list_name
